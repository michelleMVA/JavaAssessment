...
public class Main
{
    public Double assignedGrade = 0.0;
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        String printAllCourses = "";
            ...
            String courseId = scanner.next();
            Course selectedCourse = student.findCourseById(courseId);

            System.out.println( "Insert course grade for:" + selectedCourse.getName());
            Double assignedGrade = Double.valueOf(scanner.next());

            student.addGrade(selectedCourse, assignedGrade);
    }
